...
export interface Permissions extends RowDataPacket {
...
export interface Rolepermissions extends RowDataPacket {
...
export interface ArticleCategories extends RowDataPacket {
...
export interface CommentLikes extends RowDataPacket {
...
export interface FilesInfo extends RowDataPacket {
...
export interface NoteTags extends RowDataPacket {
...
export interface Notes extends RowDataPacket {
  // 源表名称: notes - 主键: `id`
  /** 无描述 可选 - 自增长  */
  id?: number;
  /** 无描述 必填   */
...
export interface Sessions extends RowDataPacket {
...
export interface Tags extends RowDataPacket {
...
export interface UserComments extends RowDataPacket {
